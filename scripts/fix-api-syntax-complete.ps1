Write-Host "Fixing all syntax errors in api.js..." -ForegroundColor Yellow

$apiFilePath = "frontend/src/services/api.js"

# Create the complete corrected api.js file
$correctedContent = @"
...
$correctedContent | Out-File -FilePath $apiFilePath -Encoding UTF8

Write-Host "api.js has been completely fixed and replaced with correct syntax" -ForegroundColor Green
Write-Host "All backslash errors have been resolved" -ForegroundColor Green
